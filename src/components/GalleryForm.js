...
const GalleryForm = () => {
  ...
  return (
    <div className="min-h-screen rounded-xl w-full shadow-xl bg-gradient-to-br from-[#fbdcec] to-indigo-100 py-8 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      ...
      <ConfirmationDialog
        ...
        onConfirm={() => {
          ...
          handleDeleteGalleryImage(deletingImage);
        }}
      />
    </div>
  );
