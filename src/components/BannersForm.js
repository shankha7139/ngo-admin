...
const BannersForm = () => {
  ...
  return (
    <div className="min-h-screen w-full rounded-xl bg-gradient-to-br from-orange-200 to-indigo-100 py-8 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
